...
public static List<TOBlock> getBlocksOfCurrentDesignableGame() throws InvalidInputException {
	...
	// Play mode
	public static void startGameTest(Block223PlayModeInterface ui) throws InvalidInputException {
		Block223 b223=Block223Application.getBlock223();
		Block223Application.setCurrentGame(b223.getGame(0));
		Game gameC = Block223Application.getCurrentGame();
		PlayedGame game = new PlayedGame("test", gameC, b223);
		game.setPlayer(null);
		
		Block223Application.setCurrentPlayableGame(game);
