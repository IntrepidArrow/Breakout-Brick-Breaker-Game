...
public class BlockController {
	...
	public static void positionBlock(int id, int xPos , int yPos,String gameName) {
		Block223 block223 = BlockApplication.getBlockApp();
		/*conditions: number of blocks less than the limit per level
		 * check if there is already a block assignment at this pos
		 * create a blockAssignment and add it to a level
		 * block.addBlockAssignment(xpos,ypos,level,game)
		 */
